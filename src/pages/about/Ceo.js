      ...
      <Container>
        <Grid container xl={12}>
          <Grid item lg={8}>
            <Typography
              variant="h3"
              sx={{ fontWeight: "700", fontSize: "53px", lineHeight: "82.5px" }}
            >
              Meet the Founders
            </Typography>
            <Typography
        ...
        <Grid container xl={12}>
          <Grid item lg={8}>
            ...
            >
              ...
              lookout for great problem solvers with passion and drive, these
              are the types of people we want to work with and learn from
              ourselves.
            </Typography>
          </Grid>
        </Grid>
        <Box sx={{ display: "flex", alignItems: "center", margin: "10px 0px" }}>
          <img src={logo} alt="icone" style={{ width: "49px", height: "49" }} />
          <Typography
            variant="h6"
            sx={{
              margin: "0px 15px",
